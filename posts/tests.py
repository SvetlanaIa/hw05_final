...
class PostTest(TestCase):
    ...
    def test_img_post(self):
        ...
        with open("zkxZrC5FZ_Y.jpg", "rb") as fp:
    ...
    def test_comment(self):
        ...
        self.assertEqual(Comment.objects.filter(
            text="I want to sleep!").count(), 0)
        self.assertEqual(Comment.objects.filter(text="Hello!").count(), 1)
...
class FollowTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="sarah", email="connor.s@skynet.com", password="12345")
        self.post_text = "You are talking about things I have not done yet in the past tense. It is driving me crazy!"
